...
CATEGORY_RULES: dict[str, list[str]] = {
    ...
    "Beverages": [
        r"\btea\b", r"\bchai\b", r"\bgreen\s*tea\b", r"\bblack\s*tea\b", r"\bcoffee\b",
        r"\bnescafe\b", r"\bjuice\b", r"\bjuices\b", r"\bnectar\b", r"\bdrink\b", r"\bdrinks\b",
        r"\bcola\b", r"\bpepsi\b", r"\bcoke\b", r"\bcoca\s*cola\b", r"\bsprite\b", r"\b7up\b",
        r"\bfanta\b", r"\bdew\b", r"\bmountain\s*dew\b", r"\bmirinda\b", r"\bwater\b",
